...
import com.crm.idnplab06.helpers.LegendHelper;
...
public class BarChart extends View {
    ...
    private List<DataEntity> serie;
    private float width_bar;
    private final float separation = 10;
    private float originY;
    private float originX;
    private float marginX;
    private Paint paintBar, paintText, paintAxis, paintHorizontalLine;
    ...
    public void setSerie(List<DataEntity> serie) {
        this.serie = serie;
        for (DataEntity s : serie) {
    ...
    public List<LegendEntity> getLegend() {
        return legendHelper.getLegendItems();
    }
    ...
    private void drawBars(Canvas canvas) {
        ...
        for (int i = 0; i < serie.size(); i++) {
            ...
            legendHelper.addLeyendItem(category, color);
            Log.d(TAG, category);
        }
